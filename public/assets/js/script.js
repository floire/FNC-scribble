    ...
    var App = {
        ...
        displayNewGameScreen : function(data){
            ...
            //$('#instructions').html("<h1>Game ID: "+App.gameID+"</h1><p>Send others this ID to join or this <a href='https://fnc-draw.000webhostapp.com/g/"+App.gameID+"'>link</a></p><h1>Users</h1>");
            $('#instructions').html("<h1>GAME ID: "+App.gameID+"</h1><p>Copy the game ID and send it to others so they can join the game!</p><h1>ACTIVE USERS:</h1>");
        ...
        updatePlayerScreen: function(data){
            ...
            var userList = "<li class='pure-menu-item'><b>USERS</b></li>";
            var pointsList = "<li class='pure-menu-item'><b>SCORE</b></li>";
            for(var i = 0; i < data.length; i++){
        ...
        sendMessage: function(){
            ...
            if (App.gameState == "playing" && chat_message.toUpperCase().indexOf(App.word) != -1 && App.gameRole != 'drawer' && !App.hasAlreadyWon){
                $("#drawer_word").html("Nice! You guessed the right word: "+App.word);
        ...
        prepareStartGame: function(data){
            ...
            if(App.gameRole == "drawer"){
                ...
                $("#drawer_word").html("<p style='color:#ff5900'>The word is:<br><b>"+App.word+"</b></p>");
            ...
            if(App.gameRole == "guesser"){
                ...
                $("#your_role").html("You are a <b>guesser</b>");
        ...
        gameEndedLobby: function(){ //!!!Change
            ...
            if(correct_count == App.players.length - 1){
                ...
                $('#correct_word_show').html(App.word+"<br>");
            }
